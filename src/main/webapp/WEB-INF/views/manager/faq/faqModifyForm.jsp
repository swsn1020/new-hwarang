	...
	<div class="container">
		...
		<table class="table">
			<tr>
				<th>분류</th>
				<td>
					<select id="category" name="category" class="form-control col-sm-3" style="display: inline-block;">
						<!-- 중요는 top에 올리기 -->
			...
			<tr>
				<td colspan="2">
					<textarea class="form-control" rows="10" name="answer" style="resize: none;">${faq.answer }</textarea>
				</td>
			</tr>
		</table>
		<div>
